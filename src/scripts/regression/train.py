...
from src.models.lightning_modules import CustomRegressionLightningModule
from src.data.regression_dataset import UTKFaceDataset


def train_model(
        model: CustomRegressionLightningModule,
        config: DictConfig,
    ...
    train_dataset = UTKFaceDataset(r"F:\research\data\utk_faces\train", transform)
    val_dataset = UTKFaceDataset(r"F:\research\data\utk_faces\val", transform)
